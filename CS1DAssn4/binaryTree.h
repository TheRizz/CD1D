...
public:
    ...
    void breadthTraversal() const;
      //Function to do a breadth traveral of the binary tree.
      //Postcondition: Nodes are printed in breadth sequence.
...
private:
    ...
    void breadth(nodeType<elemType> *p) const;
      //Function to do a breadth traversal of the binary
      //tree to which p points.
      //Postcondition: Nodes of the binary tree, to which p
      // 			   points, are printed in breadth
      //			   sequence.
...
template <class elemType>
void binaryTreeType<elemType>::breadthTraversal() const
{
    breadth(root);
}
...
template <class elemType>
void binaryTreeType<elemType>::breadth
                              (nodeType<elemType> *p) const
{
	if(p!=NULL)
	{
		...
		while(!q.empty())
		{
			nodeType<elemType> temp = q.front();
			q.pop();
			cout << temp.info << " ";
			if(temp.left != NULL)
			{
